...
create_event_grid: bool = func_app_configs.require_bool(
    "create_event_grid"
)
create_function_app: bool = func_app_configs.require_bool(
    "create_function_app"
)
create_key_vault: bool = func_app_configs.require_bool(
    "create_key_vault"
)
